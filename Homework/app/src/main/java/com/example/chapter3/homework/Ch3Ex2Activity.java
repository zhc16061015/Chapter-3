...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2_x = ObjectAnimator.ofFloat(target,
                "scaleX",1.0f,2.0f
        );
        animator2_x.setRepeatCount(ValueAnimator.INFINITE);
        animator2_x.setInterpolator(new LinearInterpolator());
        animator2_x.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animator2_x.setRepeatMode(ValueAnimator.RESTART);

        ObjectAnimator animator2_y = ObjectAnimator.ofFloat(target,
                "scaleY",1.0f,2.0f
        );
        animator2_y.setRepeatCount(ValueAnimator.INFINITE);
        animator2_y.setInterpolator(new LinearInterpolator());
        animator2_y.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animator2_y.setRepeatMode(ValueAnimator.RESTART);
